...
CREATE TABLE waSocket_identity_keys (
	our_jid  TEXT,
	their_id TEXT,
...
CREATE TABLE waSocket_pre_keys (
	jid      TEXT,
...
CREATE TABLE waSocket_sessions (
	our_jid  TEXT,
	their_id TEXT,
	session  bytea,
...
CREATE TABLE waSocket_sender_keys (
	our_jid    TEXT,
	chat_id    TEXT,
	sender_id  TEXT,
...
CREATE TABLE waSocket_app_state_sync_keys (
	jid         TEXT,
	key_id      bytea,
...
CREATE TABLE waSocket_app_state_version (
	jid     TEXT,
	name    TEXT,
...
CREATE TABLE waSocket_app_state_mutation_macs (
	jid       TEXT,
	name      TEXT,
	version   BIGINT,
...
CREATE TABLE waSocket_contacts (
	our_jid       TEXT,
	their_jid     TEXT,
	first_name    TEXT,
	full_name     TEXT,
...
CREATE TABLE waSocket_chat_settings (
	our_jid       TEXT,
	chat_jid      TEXT,
...
CREATE TABLE waSocket_privacy_tokens (
	our_jid   TEXT,
	their_jid TEXT,
...
CREATE TABLE waSocket_event_buffer (
